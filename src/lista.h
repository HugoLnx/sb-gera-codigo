...
*     valor  - ponteiro para valor do novo elemento
*
*  Condições de retorno
*     LIS_CondRetOK
*     LIS_CondRetFaltouMemoria
...
*     valor - ponteiro que terá o valor obtido.
*
*  Condições de retorno
*     LIS_CondRetOK
*     LIS_CondRetListaVazia
...
*     pvalor - ponteiro para o ponteiro do valor
*
*  Condições de retorno
*     - LIS_CondRetOK
*
...
*     valor   - ponteiro para o ponteiro do valor procurado
*
*  Condições de retorno
